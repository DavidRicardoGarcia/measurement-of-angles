/*
 Note: The MPU92501 is an I2C sensor and uses the Arduino Wire library.
...
// document; the MPU92501 and MPU9150 are virtually identical but the latter has
...
#define WHO_AM_I_MPU92501   0x75 // Should return 0x71
...
#define ADO 0
#if ADO
#define MPU92501_ADDRESS 0x69  // Device address when ADO = 1
#else
#define MPU92501_ADDRESS 0x68  // Device address when ADO = 0
...
class MPU92501
{
  ...
  public:
    ...
    void initMPU92501();
    void calibrateMPU92501(float * gyroBias, float * accelBias);
    void MPU92501SelfTest(float * destination);
    void writeByte(uint8_t, uint8_t, uint8_t);
    uint8_t readByte(uint8_t, uint8_t);
    void readBytes(uint8_t, uint8_t, uint8_t, uint8_t *);
    void magcalMPU92501(float * dest1, float * dest2,int c); 
};  // class MPU92501
