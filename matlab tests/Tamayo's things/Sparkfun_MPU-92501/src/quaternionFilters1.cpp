...
void MadgwickQuaternionUpdate1(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float deltat)
{
...
void MahonyQuaternionUpdate1(float ax, float ay, float az, float gx, float gy, float gz, float mx, float my, float mz, float deltat)
{
  // short name local variable for readability
  float q1 = q[0], q2 = q[1], q3 = q[2], q4 = q[3];
  float norm;
...
const float * getQ1 () { return q; }
const float getQuaW1 () { return q[0]; }
const float getQuaX1 () { return q[1]; }
const float getQuaY1 () { return q[2]; }
const float getQuaZ1 () { return q[3]; }
