...
//  Wire1.beginTransmission(0x69);          //test for MPR121 on second TWI port
...
{  
 ...
 // Set sample rate = gyroscope output rate/(1 + SMPLRT_DIV)
  writeByte(MPU9250_ADDRESS, SMPLRT_DIV, 0xff);  // Use a 200 Hz rate; a rate consistent with the filter update rate 
